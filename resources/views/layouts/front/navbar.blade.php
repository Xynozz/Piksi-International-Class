  ...
  <div class="container">
    <div class="row" style="width: 150%">
        ...
        <ul class="social-links">
          ...
          <li style="color: white"><h6><a href="https://www.facebook.com/piksiganeshabdg1"><i class="fab fa-facebook-f"></i></a></h6></li>
          <li><h6><a href="https://www.instagram.com/piksi_ganesha_official/profilecard/?igsh=ajgxZW5mM3YzOXlv "><i class="fab fa-instagram"></i></a></h6></li>
          <li><h6><a href="https://www.tiktok.com/@piksi_ganesha"><i class="fab fa-tiktok"></i></a></h6></li>
          <li><h6><a href="https://www.youtube.com/c/PiksiGaneshaOfficial"><i class="fab fa-youtube"></i></a></h6></li>
        </ul> 
    </div>
  </div>
</div>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="" class="logo d-flex align-items-center me-auto">
        ...
        <img src="{{asset('front/assets/img/logo piksi.png')}}" alt="">
        <h1 class="sitename">Internasional Class Politeknik Piksi Ganesha</h1>
      </a>

      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="{{url('/')}}" class="active">Home<br></a></li>
          <li><a href="{{url('https://sdgscenter.piksi.ac.id/')}}" class="active">SDGs</a></li>
